...
/** Desktop two-pane settings layout: navigation card on the left, content on the right. */
const SettingsShell = ({
  title,
  description,
  icon: Icon,
...
export const SectionHeader = ({ icon: Icon, title, description, action }: SectionHeaderProps) => (
