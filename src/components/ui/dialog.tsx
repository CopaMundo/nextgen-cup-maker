...
>(({ className, children, onOpenAutoFocus, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Close
      aria-label="Sluiten"
      className="fixed right-2 top-2 z-[60] rounded-full bg-background/95 p-2 text-foreground shadow-md ring-offset-background transition-opacity hover:opacity-100 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 disabled:pointer-events-none sm:right-4 sm:top-4"
    >
      <X className="h-4 w-4" />
