...
import { focusFirstDialogField } from "@/hooks/useDialogFocus";
  ...
  <DialogPortal>
    ...
    >
      ...
      <DialogPrimitive.Close
        aria-label="Sluiten"
        className="absolute right-3 top-3 z-[60] rounded-full bg-background p-1.5 text-foreground shadow-md ring-1 ring-border/60 ring-offset-background transition-opacity hover:opacity-100 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 disabled:pointer-events-none sm:-right-11 sm:top-3"
      >
        <X className="h-4 w-4" />
