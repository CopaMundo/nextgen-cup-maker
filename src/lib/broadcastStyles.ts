...
// ── WORLD CUP 26 ───
  wc26: {
    ...
    timeslotHeader: "bg-primary/[0.10] text-foreground flex items-center gap-2 px-3 py-2 border-l-4 border-y border-r border-primary shadow-[inset_0_1px_0_hsl(var(--primary)/0.35)]",
