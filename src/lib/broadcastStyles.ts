...
// ── WORLD CUP 26 ───
  wc26: {
    ...
    timeslotHeader: "wc26-context bg-foreground text-foreground flex items-center gap-2 px-3 py-1 border-b border-foreground",
    ...
    timeslotHeaderMeta: "font-['Barlow_Condensed'] text-[10px] font-bold uppercase tracking-[0.14em] text-muted-foreground",
