...
const STYLES: Record<BroadcastStyle, Record<string, string>> = {
  ...
  serie_a: {
    ...
    timeslotHeader: "bg-secondary flex items-center gap-2 px-3 py-1 border-b border-border border-l-2 border-l-primary",
    timeslotBadge: "inline-flex items-center rounded-none bg-primary/10 border border-primary/30 px-2 py-0 font-['Barlow_Condensed'] text-[11px] font-extrabold text-primary tabular-nums",
