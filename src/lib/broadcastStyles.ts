...
const STYLES: Record<BroadcastStyle, Record<string, string>> = {
  ...
  copa_mundo_bc: {
    ...
    timeslotHeader: "bg-primary/[0.08] text-foreground flex items-center gap-2 px-3 py-1 border-l-4 border-y border-r border-primary rounded-t-[3px]",
    ...
    timeslotHeaderMeta: "text-[10px] font-semibold uppercase tracking-[0.06em] text-primary",
  ...
  european_nights: {
    ...
    timeslotHeader: "en-timeslot-header bg-primary text-primary-foreground flex items-center gap-2 px-3 py-1",
    timeslotBadge: "inline-flex items-center rounded-[3px] bg-primary-foreground/15 border border-primary-foreground/30 px-2 py-0 font-['Roboto_Condensed'] text-[11px] font-extrabold text-primary-foreground tabular-nums",
    timeslotHeaderMeta: "font-['Roboto_Condensed'] text-[10px] font-bold uppercase tracking-[0.06em] text-primary-foreground/85",
  ...
  retro_bw: {
    ...
    timeslotHeader: "bg-foreground text-background flex items-center gap-2 px-3 py-1 border-b border-foreground",
    timeslotBadge: "inline-flex items-center rbw-card bg-background px-2 py-0 font-['Barlow_Condensed'] text-[11px] font-extrabold text-foreground tabular-nums",
    timeslotHeaderMeta: "font-['Barlow_Condensed'] text-[10px] font-bold uppercase tracking-[0.1em] text-background/70",
...
// ── WORLD CUP 26 ───
  wc26: {
    ...
    tabActive: "flex-1 px-3 py-2 wc26-card bg-[hsl(var(--broadcast-cyan))] text-[hsl(var(--broadcast-score-foreground))] font-['Barlow_Condensed'] text-[12px] font-bold uppercase tracking-[0.1em] transition-colors",
    ...
    matchScoreWin: "inline-flex min-w-[1.55rem] items-center justify-center rounded-[3px] bg-[hsl(var(--broadcast-cyan))] px-1.5 py-0.5 font-bold text-[hsl(var(--broadcast-score-foreground))]",
    matchScoreLose: "inline-flex min-w-[1.55rem] items-center justify-center rounded-[3px] bg-[hsl(var(--broadcast-cyan))] px-1.5 py-0.5 font-bold text-[hsl(var(--broadcast-score-foreground))]",
    ...
    tableRowAlt: "bg-secondary/35",
    ptsBadge: "inline-flex items-center justify-center min-w-[24px] rounded-[3px] bg-[hsl(var(--broadcast-cyan))] px-1.5 py-0.5 font-['Barlow_Condensed'] text-[13px] font-bold text-[hsl(var(--broadcast-score-foreground))] tabular-nums",
    timeslotHeader: "bg-primary/[0.08] text-foreground flex items-center gap-2 px-3 py-1 border-l-4 border-y border-r border-primary rounded-t-[6px]",
    timeslotBadge: "inline-flex items-center wc26-card bg-primary px-2 py-0 font-['Barlow_Condensed'] text-[11px] font-bold text-primary-foreground tabular-nums",
    timeslotHeaderMeta: "font-['Barlow_Condensed'] text-[10px] font-bold uppercase tracking-[0.14em] text-primary",
    ...
    phaseTabActive: "bg-[hsl(var(--broadcast-cyan))] text-[hsl(var(--broadcast-score-foreground))] border border-[hsl(var(--broadcast-cyan))]",
    phaseTabInactive: "bg-card border border-border text-muted-foreground hover:text-foreground",
...
// ── LA ROSA ───
  la_rosa: {
    ...
    timeslotHeader: "bg-foreground text-background flex items-center gap-2 px-3 py-1",
    timeslotBadge: "inline-flex items-center rounded-none font-['Roboto_Condensed'] text-[13px] font-black text-background tabular-nums tracking-[0.02em]",
    timeslotHeaderMeta: "font-['Roboto_Condensed'] text-[10px] font-bold uppercase tracking-[0.14em] text-background/70",
...
// ── TELETEXT FOOTBALL ───
  teletext: {
    ...
    timeslotBadge: "font-['VT323'] text-[18px] tabular-nums tracking-[0.04em]",
    timeslotHeaderMeta: "font-['VT323'] text-[11px] uppercase tracking-[0.1em]",
