...
const STYLES: Record<BroadcastStyle, Record<string, string>> = {
  ...
  copa_mundo_bc: {
    ...
    matchLegBadge: "inline-flex items-center rounded-[3px] bg-primary/15 px-1.5 py-0.5 text-[9px] font-bold uppercase text-primary",
    ...
    timeslotHeader: "bg-primary/[0.08] text-foreground flex items-center gap-2 px-3 py-2 border-l-4 border-y border-r border-primary rounded-t-[3px]",
    timeslotBadge: "inline-flex items-center rounded-[3px] border border-primary bg-primary/10 px-2 py-0.5 text-[11px] font-bold text-primary tabular-nums",
    timeslotHeaderMeta: "text-[11px] font-medium text-primary",
  ...
  european_nights: {
    ...
    matchLegBadge: "inline-flex items-center rounded-[3px] bg-primary px-1.5 py-0.5 font-['Roboto_Condensed'] text-[9px] font-bold uppercase text-primary-foreground",
  ...
  serie_a: {
    ...
    matchLegBadge: "inline-flex items-center rounded-none bg-primary px-1.5 py-0.5 font-['Barlow_Condensed'] text-[9px] font-bold uppercase text-primary-foreground",
    matchTeamRow: "px-3 py-2",
  ...
  retro_bw: {
    ...
    matchContextText: "font-['Barlow_Condensed'] text-[11px] font-bold uppercase tracking-[0.1em] text-muted-foreground",
    matchLegBadge: "inline-flex items-center rbw-card bg-foreground px-1.5 py-0.5 font-['Barlow_Condensed'] text-[9px] font-bold uppercase text-background",
