...
const STYLES: Record<BroadcastStyle, Record<string, string>> = {
  ...
  serie_a: {
    ...
    timeslotHeader: "sa-gradient-bar flex items-center gap-2 px-3 py-1",
    timeslotBadge: "inline-flex items-center rounded-none bg-white/15 border border-white/30 px-2 py-0 font-['Barlow_Condensed'] text-[11px] font-extrabold text-white tabular-nums",
    timeslotHeaderMeta: "font-['Barlow_Condensed'] text-[10px] font-bold uppercase tracking-[0.1em] text-white/85",
...
// ── LA ROSA ───
  la_rosa: {
    ...
    timeslotHeader: "bg-[hsl(var(--broadcast-surface-secondary))] text-foreground flex items-center gap-2 px-3 py-1 border-b border-[hsl(var(--broadcast-border))]",
    timeslotBadge: "inline-flex items-center rounded-none font-['Roboto_Condensed'] text-[13px] font-black text-foreground tabular-nums tracking-[0.02em]",
    timeslotHeaderMeta: "font-['Roboto_Condensed'] text-[10px] font-bold uppercase tracking-[0.14em] text-muted-foreground",
...
// ── TELETEXT FOOTBALL ───
  teletext: {
    ...
    timeslotHeader: "flex items-center gap-2 px-3 py-1 bg-[hsl(var(--broadcast-surface-secondary))]",
    timeslotBadge: "font-['VT323'] text-[18px] tabular-nums tracking-[0.04em] text-[hsl(var(--broadcast-cyan))]",
    timeslotHeaderMeta: "font-['VT323'] text-[11px] uppercase tracking-[0.1em] text-[hsl(var(--broadcast-cyan))]/70",
